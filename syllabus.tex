...
% could be much earlier in course) - Larissa gave lecture - got Davide's code
% HW 3.1 is scraping, 3.2 is regression
10/20 & Anomaly Detection - SVD III & & HW 3.1 & \\ 
10/21 &&&& HW 2.2 \\
...
11/1 & Classification: k-NN & &  &\\ 
% PDF plus jupyter notebook (skip naive bayes?)
11/3 & Classification: SVM, Naive Bayes & & &\\ 
11/4 &&&& HW 3.1, Proj Proposal\\
\hline

11/8 & Regression: Linear Regression && HW 3.2  &\\ 
...
11/22 & Network Analysis I &  & &Prog report 2\\ 
11/24 & NO CLASS; Thanksgiving Break  & & & \\ 
 \hline

% HW 5 is on map reduce; requires triangle counting
11/29 & Network Analysis II &  & & \\ 
12/1 & Graph Clustering  &&HW 5 &\\
12/2 &&&& HW 4\\
\hline 

12/6 & Text Analysis and Topic Modeling  & & & \\ 
12/8 & Poster Session &  &  &\\ 
\hline 
12/12 &&&& HW 5\\
